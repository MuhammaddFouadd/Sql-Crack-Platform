...
import { Check, X, Wand2, Eye, EyeOff, HelpCircle, Database, ChevronDown, TableIcon } from 'lucide-react'
...
export default function PracticeAnswer({ lessonId, question, hint, solution, index }: PracticeAnswerProps) {
  ...
  const loadRawData = useCallback(async () => {
    ...
    const tables = parseTables(question)
